...
import { fetchLatestInvoices, getClientData } from '~/app/lib/data';
...
export default async function LatestInvoices() { // Make component async, remove the props
    const receivedInvoices = await fetchLatestInvoices();
    const latestInvoices = receivedInvoices.filter(invoice => {
        invoice.id != null
        invoice.name != undefined
        invoice.email != undefined
        invoice.image_url != undefined
    }); 
