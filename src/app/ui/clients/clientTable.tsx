...
export default function ClientTable() {
  ...
  return (
    ...
    //                     {clients?.map((client) => (
    //                         <div key={client.id} className="mb-2 w-full rounded-md bg-white p-4">
    //                             <div className="flex items-center justify-between border-b pb-4">
    //                                 <div>
    //                                     <div className="mb-2 flex items-center">
    //                                         <Image src={client.image_url}
    //                                             className="mr-2 rounded-full"
    //                                             width={28} height={28} alt={`${client.name}'s profile picture`}
    //                                         />
    //                                         <p>{client.name}</p>
    //                                     </div>
    ...
    //                   Client Total Policies: {client.total_invoices}
    //                 </p>
    //                 {/* <p>{formatDateToLocal(client.date)}</p> */}
    //               </div>
