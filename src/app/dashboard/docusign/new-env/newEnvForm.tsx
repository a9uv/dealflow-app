...
export default function NewEnvelope() {
 ...
 const toggleVisibility = (envelopeId: string) => {
    ...
    // const handleNewEnvelopeForm = (event: React.FormEvent<HTMLFormElement>) => {
    //     event.preventDefault()

    //     const rawFormData: EnvelopeData = {
    //     name: formData.name,
    //     email: formData.email,
    //     subject: formData.subject,
    //     message: formData.message,
    //     chosenForm: formData.chosenForm,
    //     }
                ...
                />
                           ...
                           <div className="flex flex-col max-w-6/12 mt-6">
                            <button onClick={tableVisibility}
                             className="mt-4 max-w-16 flex h-10 items-center rounded-lg bg-blue-500 px-4 text-sm font-medium text-white transition-colors hover:bg-blue-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-500 active:bg-blue-600 aria-disabled:cursor-not-allowed aria-disabled:opacity-50"
                            > Select Form </button>
                            {tableVisible &&
